module.exports = {
	...
	//异步加载
	'/v2/client/1/tzy/mtest/all' : 'mock::api/test.json',
	'/v2/client/1/profile/plan/list' : 'mock::api/history.json',
	...
	'/v2/client/1/tzy/appointment/types': "mock::api/appointmentType.json"
};