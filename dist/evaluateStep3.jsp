...
<head>
	...
	<title>高考志愿</title>
	<link href="/static/web/css/vendors.0cd2f40b.css" rel="stylesheet"><link href="/static/web/css/evaluateStep3.7bc2dd21.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.33b609d6.js"></script><script src="/static/web/js/evaluateStep3.36bfcdfa.js"></script></body>
</html>