...
<head>
	...
	<title>淘志愿</title>
<link href="/static/web/css/vendors.f2b77075.css" rel="stylesheet"><link href="/static/web/css/pay/book.719892b2.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
							...
							<div class="col2 radioWrap rel media-body">
								...
								<div class="row">
									...
									<span class="inputWrap dib">
										<input type="text" class="form-control input" id="card" placeholder="请输入预售卡支付">
									</span>
									</label>
								</div>
							</div>
	...
	<script src="/static/web/js/vendors.679264d9.js"></script><script src="/static/web/js/pay/book.761c05e3.js"></script></body>
</html>