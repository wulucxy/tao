...
<head>
	<meta charset="UTF-8">
	<title>淘志愿</title>
<link href="/static/web/css/vendors.a4349030.css" rel="stylesheet"><link href="/static/web/css/pay/evaluate.abae95ad.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.js"></script><script src="/static/web/js/pay/evaluate.js"></script></body>
</html>