...
<head>
	...
	<title>高考志愿</title>
	<link href="/static/web/css/vendors.0cd2f40b.css" rel="stylesheet"><link href="/static/web/css/evaluateStep2.f5d17fd4.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.33b609d6.js"></script><script src="/static/web/js/evaluateStep2.ad160adf.js"></script></body>
</html>