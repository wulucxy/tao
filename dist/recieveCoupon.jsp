...
<body>
				...
				<div class="content">
					...
					<div class="formWrap clearfix">
						<div class="column col1 fl">
							...
							<div class="recieve row inline clearfix" id="recieveCouponForm">
	...
	<script src="/static/web/js/vendors.js"></script><script src="/static/web/js/recieveCoupon.js"></script></body>
</html>