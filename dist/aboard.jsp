...
<head>
	...
	<title>高考志愿</title>
	<link href="/static/web/css/vendors.ba049ff4.css" rel="stylesheet"><link href="/static/web/css/aboard.3cb1a115.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.71db2eea.js"></script><script src="/static/web/js/aboard.79e69069.js"></script></body>
</html>