...
<head>
	...
	<title>淘志愿</title>
<link href="/static/web/css/vendors.588786b5.css" rel="stylesheet"><link href="/static/web/css/scoreLineResult.f921b2e1.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.js"></script><script src="/static/web/js/scoreLineResult.js"></script></body>
</html>