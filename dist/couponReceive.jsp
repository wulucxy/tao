...
<head>
	...
	<title>淘志愿</title>
<link href="/static/web/css/vendors.ba049ff4.css" rel="stylesheet"><link href="/static/web/css/couponReceive.37273f77.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.71db2eea.js"></script><script src="/static/web/js/couponReceive.29aa27ed.js"></script></body>
</html>