...
<head>
	...
	<title>淘志愿</title>
<link href="/static/web/css/vendors.ba049ff4.css" rel="stylesheet"><link href="/static/web/css/createAppointment.bf615b08.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.71db2eea.js"></script><script src="/static/web/js/createAppointment.77b1525f.js"></script></body>
</html>