...
<head>
	...
	<title>淘志愿</title>
<link href="/static/web/css/vendors.da0ee6f1.css" rel="stylesheet"><link href="/static/web/css/recommendUni.67ded53d.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.5ef56f5a.js"></script><script src="/static/web/js/recommendUni.e1e624cc.js"></script></body>
</html>