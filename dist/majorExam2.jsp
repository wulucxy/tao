...
<head>
	...
	<title>专业选择测试</title>
<link href="/static/web/css/vendors.ba049ff4.css" rel="stylesheet"><link href="/static/web/css/majorExam2.f759be07.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.71db2eea.js"></script><script src="/static/web/js/majorExam2.68b6ea89.js"></script></body>
</html>