...
<head>
	...
	<title>淘志愿</title>
<link href="/static/web/css/vendors.ba049ff4.css" rel="stylesheet"><link href="/static/web/css/evaluateResultV2.14a67a7d.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.71db2eea.js"></script><script src="/static/web/js/evaluateResultV2.9c90c1db.js"></script></body>
</html>