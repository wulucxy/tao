...
<head>
	...
	<title>淘志愿</title>
<link href="/static/web/css/vendors.f2b77075.css" rel="stylesheet"><link href="/static/web/css/evaluateResultV2.6cfc9cad.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.ee570c96.js"></script><script src="/static/web/js/evaluateResultV2.da35be2a.js"></script></body>
</html>