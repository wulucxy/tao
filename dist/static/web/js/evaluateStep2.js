...
/***/ (function(module, exports, __webpack_require__) {
	...
	//弹窗模板
	var tmpl_detail = __webpack_require__(147);
	var tmpl_questions = __webpack_require__(148);
	
	//弹窗模板
	var tmpl_school = __webpack_require__(220);
	var tmpl_list = __webpack_require__(221);
	var tmpl_major = __webpack_require__(222);
	var majors = __webpack_require__(223);
	...
	// panel
	var tmpl_panel = __webpack_require__(224);
	
	// major
	var tmpl_majorList = __webpack_require__(225);
	
	// divider
	var tmpl_divider = __webpack_require__(226);
...
/***/ (function(module, exports) {
	...
	'" universitymajorid="' +
	((__t = ( wishes[i].universityMajorId )) == null ? '' : __t) +
...
/***/ (function(module, exports) {
	...
	__p += '\n	 	<li>\n		 	<label for="major_' +
	((__t = ( majorList[i].majorUuid )) == null ? '' : __t) +
	...
	'" universitymajorid="' +
	((__t = ( majorList[i].universityMajorId )) == null ? '' : __t) +
	'" />\n		 		<em>' +
	((__t = ( majorList[i].majorName )) == null ? '' : __t) +
	'\n		 			';
