...
/***/ (function(module, exports, __webpack_require__) {
	...
	//数据绑定
	var dataSet = __webpack_require__(299);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var tmpl = __webpack_require__(300);
...
/***/ (function(module, exports) {
	...
	with (obj) {
	 ...
	 if (majorUnscrambleList.length == 0 && page == 1) { ;
	__p += '\n	<li class="no_transList"><i class="noListIcon"></i><em class="vm">暂无记录</em></li>\n';
	 }else{ ;
	__p += '	\n';
	 for (var i = 0; i < majorUnscrambleList.length; i++) { ;
	__p += '\n<li class="clearfix majorUnscrambleItem">\n	<a href=\'/infoV3/' +
	((__t = ( majorUnscrambleList[i].newsId )) == null ? '' : __t) +
	'/majorUnscrambleDetail\' class="media">\n	<span class="imgWrap">\n		<img src="' +
	((__t = ( majorUnscrambleList[i].newsIconUrl )) == null ? '' : __t) +
	'" class="responsive" />\n	</span>\n	<div className="media-body">\n		<h4 class="name">' +
	((__t = ( majorUnscrambleList[i].newsTitle )) == null ? '' : __t) +
	'</h4>\n		<div class="detail">样本院校：' +
	((__t = ( majorUnscrambleList[i].newsUniversityName )) == null ? '' : __t) +
	'</div>\n	</div>\n	<div class="footCnt clearfix">\n		<span class="moment">' +
	((__t = ( majorUnscrambleList[i].date )) == null ? '' : __t) +
	'</span>\n	</div>\n	</a>\n</li>\n';
	 }} ;
