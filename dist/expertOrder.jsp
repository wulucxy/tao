...
<head>
	<meta charset="UTF-8">
	<title>淘志愿</title>
<link href="/static/web/css/vendors.f281d9d8.css" rel="stylesheet"><link href="/static/web/css/expertOrder.0e93ab2c.css" rel="stylesheet"></head>
<body>
	<!-- 公共头部 -->
	...
	<script src="/static/web/js/vendors.js"></script><script src="/static/web/js/expertOrder.js"></script></body>
</html>